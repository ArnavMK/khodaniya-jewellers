...
class AppRoutes {
  ...
  static const String profile = '/profile'; // user profile page
  static const String setting = '/settings'; // app settings page
  static const String itemDetails = '/item-details'; // details page for selected item
  static const String favorites = '/favorites'; // details page for selected item
}
